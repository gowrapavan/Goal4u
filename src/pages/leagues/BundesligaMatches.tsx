...
const BundesligaMatchdaysWithSidebar = () => {
 ...
 const scrollParent = activeTab.parentElement; // assumes parent scrolls
  ...
  return (
    <div className="deb-layout container-fluid">
  <div className="content-wrapper d-flex flex-column flex-lg-row gap-4">
            ...
            {matches.map((match: any, idx: number) => {
              ...
              return (
                <div
                  ...
                  onClick={() =>
                    navigate(
                      `/livematch?matchId=${match.GameId}&competition=deb`
                    )
                  }
                >
    ...
    <div className="standings-section d-flex flex-column">
      <div className="table-sidebar flex-grow-1 d-flex flex-column">
        <h5 className="fw-bold mb-3">Bundesliga Standings</h5>
  ...
  <style jsx>{`
    ...
    .table-sidebar {
      ...
      border-radius: 6px;
      padding: 16px;
      box-shadow: 0 1px 4px rgba(215, 9, 9, 0.47);
      height: 100%;
    }
      .scroll-wrapper {
...
.desktop-tabs {
  padding-top: 8px; /* vertical scroll padding */
    ...
    .standings-table thead th {
      ...
      text-align: center;
      font-size: 0.85rem;
      border-bottom: 1px solid #e6dedeff;
    }
    ...
    .match-box {
      ...
      border-radius: 6px;
      padding: 12px;
      box-shadow: 0 1px 2px rgba(245, 40, 40, 0.62);
    }
...
.match-box:hover {
  ...
  font-weight: 600; /* optional: reduce boldness */
      ...
      .match-box {
        ...
        border-radius: 6px;
        padding: 12px;
      box-shadow: 0 1px 2px rgba(130, 1, 1, 0.88);
      }
...
export default BundesligaMatchdaysWithSidebar;
